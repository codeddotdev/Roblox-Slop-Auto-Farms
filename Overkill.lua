...
local function Update_Aimbot()
    ...
    local is_key_down = Aim_Key == Enum.UserInputType.MouseButton2
        and Services.User_Input:IsMouseButtonPressed(Enum.UserInputType.MouseButton2)
        or false
...
if UI_Loaded and UI_Library then
    ...
    local Aimbot_Group = Tabs.Aimbot:AddLeftGroupbox("Aimbot")
    Aimbot_Group:AddToggle("Aimbot_Enabled", { Text = "Enabled", Default = true, Tooltip = "Toggle aimbot" })
    Aimbot_Group:AddSlider("Aim_FOV", { Text = "FOV", Default = 150, Min = 20, Max = 500, Rounding = 0, Suffix = "px" })
    Aimbot_Group:AddSlider("Aim_Smoothness", { Text = "Smoothness", Default = 3, Min = 1, Max = 20, Rounding = 1 })
    Aimbot_Group:AddDropdown("Aim_Part", { Text = "Aim Part", Default = "Head", Values = { "Head", "HumanoidRootPart", "Torso", "Random" }, Multi = false })
    Aimbot_Group:AddToggle("Visible_Check", { Text = "Visible Check", Default = true })
    Aimbot_Group:AddToggle("Team_Check", { Text = "Team Check", Default = false })
    Aimbot_Group:AddToggle("FOV_Circle", { Text = "Draw FOV", Default = true })
    Aimbot_Group:AddLabel("FOV Color"):AddColorPicker("FOV_Color", { Default = Color3.fromRGB(255, 255, 255), Title = "FOV Circle Color" })
    ...
    Toggles.Aimbot_Enabled:OnChanged(function() Aimbot_Enabled = Toggles.Aimbot_Enabled.Value end)
